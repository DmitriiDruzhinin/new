...
time_value.addEventListener('change', () => { 		// time
...
budget_btn.addEventListener('click', () => {
	count_budget_value.value = ((money / 30).toFixed(2));
});
...
time_value.addEventListener('change', () => {		// discount
	let time = time_value.value;
	...
	if (time < 0){
		...
		} else if (time >= 9 && time <= 11){		// с 9 до 11 скидка 80%
